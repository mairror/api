...
Instead, email organization members with as much details as possible so that it can be handled confidentially.

## Support

If you want help with your Renovate configuration, go to the [discussions tab in the Mairror infrastructure repository](https://github.com/mairror/infrastructure/discussions) and open a new "config help" discussion post.
